<?php
	$file = 'Re-skinning.zip';
	$size = '11.7 MB';
	$offers = 'https://cpbldi.com/f1ae36c';
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<section class="jk_page_not_found hk_section_padding" style="padding-bottom:0 !important;">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="hk_huge_text"><h1 style="color:#0096ff;"><?php echo $file ; ?></p></div>
                <p class="hk_directory_text"><?php echo $file ; ?> | <?php echo $size ; ?></p>
                <a href="<?php echo $offers ; ?>" class="hk_btn hk_err_btn" id="downloadButton"> <span class="fa fa-cloud-download"></span>Download Now</a>
            </div>
        </div>
    </div>
</section>
